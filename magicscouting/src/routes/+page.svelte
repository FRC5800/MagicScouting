...
<section class="pt-2">
	...
	<img on:click={() => {requestPermissions(); goto('/qrCodeScanner')}} src="{qrReader}" alt="QR Code Reader Button" class="absolute z-10 w-10 top-3 right-4">
	<header>
...
<h4 class="absolute italic font-semibold text-gray-500 bottom-3 right-4">MagicScouting Beta v1.5</h4>
