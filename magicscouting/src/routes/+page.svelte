<script>
	...
	$: isDataBaseSetted = $dataBase ? true : false;
	$: if ($dataBase != '') {
...
<Modal bind:showModal bind:showConfig bind:showDataBase>
	...
	{:else if showModal && !showConfig && !isDataBaseSetted}
		<DataBaseAlert bind:isDataBaseSetted={isDataBaseSetted} bind:showMenu={showModal}/>
	{/if}
</Modal>
