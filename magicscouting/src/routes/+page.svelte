<script>
	// @ts-nocheck
	import '../app.css';
	import qrReader from '$lib/assets/qrcode-reader.svg';
...
<section class="pt-2">
	...
	<svg class="absolute z-10 w-10 top-3 right-4 fill-black dark:fill-white" on:click={() => {requestPermissions(); goto('/qrCodeScanner')}}  width="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<h4 class="fixed italic font-semibold text-gray-500 bottom-3 right-4">MagicScouting Beta v1.7</h4>
