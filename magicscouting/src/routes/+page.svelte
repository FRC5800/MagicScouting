...
<section class="pt-2">
	...
	<svg class="absolute z-10 w-10 top-3 right-4 fill-black dark:fill-white" on:keydown={(e) => {goto('/qrCodeScanner')}} on:click={() => {goto('/qrCodeScanner')}}  width="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
